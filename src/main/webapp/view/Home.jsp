...
<section class="articoliHome" id="articoliHome">
    ...
    <h2 class="title">Sfoglia il nostro catalogo</h2>
       ...
       <% for (ArticoloBean articolo : articoli){%>
        <div class="box">
            ...
            <div class="info">
                ...
                <div class="subInfo">
                    <strong class="price"><%=articolo.getPrezzo()%></strong>
                    <a class="btn" href="../articolo?idArticolo=<%=articolo.getIdArticolo()%>">Vai al Prodotto</a>
                    <a class="btn" href="../aggiungicarrello?idArticolo=<%=articolo.getIdArticolo()%>&qta=1"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16">
